...
# Lê o contrato que você já tem
print("[*] Gerando PoC para AaveV3CollateralVault.sol...")
...
with open("PoC_Twyne_65.t.sol", "w") as f:
    f.write(poc_code)

print("[OK] Arquivo gerado: PoC_Twyne_65.t.sol")
print("[OK] Linhas:", len(poc_code.split('\n')))
print("\n--- CONTEUDO DO POC ---")
print(poc_code[:800])
